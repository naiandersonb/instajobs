...
import { Avatar, Box, Button, Menu, MenuButton, MenuDivider, MenuItem, MenuList, Slide, Stack, useDisclosure, useMediaQuery } from "@chakra-ui/react";
import Image from "next/image";
import Link from "next/link";
import { useEffect, useState } from "react";
import {
  FiHome, FiLogOut, FiMessageCircle,
  FiPlusSquare, FiSearch, FiSettings, FiUser, FiX
} from 'react-icons/fi';
...
export const Navbar = () => {
  ...
  return (
    <Box bg={theme.colors.brand.white} boxShadow='xs' position='fixed' top={0} left={0} right={0} zIndex={100}>
      <Box
        display='flex'
        alignItems='center'
      ...
      >
        <Image
          src={!isLargerThan768 ? '/images/logo-full.svg' : '/images/logo-lettering.svg'}
          alt="Instajobs"
